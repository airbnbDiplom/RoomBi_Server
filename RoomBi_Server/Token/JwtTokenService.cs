            ...
            var claims = new List<Claim>
             {
                ...
                user.PF != null ? new Claim("PF", user.PF) : new Claim("PF", ""),
                ...
                user.DateOfBirth != null ? new Claim("DateOfBirth", user.DateOfBirth.Value.ToString("yyyy-MM-dd")) : new Claim("DateOfBirth", ""),
